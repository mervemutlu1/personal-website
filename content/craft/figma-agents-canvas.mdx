...
write to it. So the reverse workflow of building first,
then bringing it into Figma, felt impossible.
...
Claude Code read the entire codebase, including components,
...
their conventions, and their standards, are going to
